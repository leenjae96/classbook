...
public class TeacherAttendanceService {
    ...
    public TeacherAttendanceDto.Response getAttendance(Long teacherId, LocalDate date) {
        TeacherReport attendance = teacherReportRepository.findByTeacherIdAndDate(teacherId, date);
        if (attendance == null) {
    ...
    public void updateAttendance(TeacherAttendanceDto.Request request, LocalDate date) {
        ...
        TeacherReport existingRecord = teacherReportRepository.findByTeacherIdAndDate(request.teacherId(), date);
